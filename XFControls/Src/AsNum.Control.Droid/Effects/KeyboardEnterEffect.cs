...
namespace AsNum.XFControls.Droid.Effects
{
    ...
    public class KeyboardEnterEffect : PlatformEffect
    {
        ...
        private ImeAction Convert(A.KeyboardEnterTypes key)
        {
            switch (key)
            {
                case A.KeyboardEnterTypes.Done:    return ImeAction.Done;
                case A.KeyboardEnterTypes.Go:      return ImeAction.Go;
                case A.KeyboardEnterTypes.Next:    return ImeAction.Next;
                case A.KeyboardEnterTypes.Search:  return ImeAction.Search;
                case A.KeyboardEnterTypes.Send:    return ImeAction.Send;
